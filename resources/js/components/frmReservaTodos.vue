      ...
      <div class="card">
        ...
        <template v-else>
          <div class="card-body">
            <div class="form-group row border">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input
                    @change="calcularTotalDiasServicioPaquete()"
                    type="datetime-local"
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <!-- <v-select
                    ...
                    :getOptionKey="seleccionadoTipo"
                  /> -->
                  <select class="form-control" v-model="data.idSalon"  @change="obtenerPrecioSalon($event)">
                      <option value="0" disabled>Seleccione Salon</option>

                      <option  v-for="obj in arraySalon" :key="obj.id"     
            ...
            <label>Cada 12 Horas es una jornada</label><br>
            <b>Total Jornadas: <p v-text="totalDiasServicioPaquete"></p> </b>
            <!-- tabla para el precio del salon -->
...
export default {
  ...
  methods: {
    calcularTotalDiasServicioPaquete(){
        var date_1 = new Date(this.data.fechaInicio);
        var date_2 = new Date(this.data.fechaFin);
        var day_as_milliseconds = 86400000;
        var diff_in_millisenconds = date_2 - date_1;
        var diff_in_days = diff_in_millisenconds / day_as_milliseconds;
        /*total en horas */
        var totalHoras=diff_in_days*24;
        var jornada=totalHoras/12;
        /*redondeamos hacia arriba */
        var jornadaEntera=Math.ceil(jornada);
        this.totalDiasServicioPaquete=jornadaEntera;
        console.log(jornada +' Entera: '+ jornadaEntera);
    },
    
    obtenerPrecioSalon(event){
